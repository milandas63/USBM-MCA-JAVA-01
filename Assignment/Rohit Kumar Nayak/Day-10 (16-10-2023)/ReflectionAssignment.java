...
public class ReflectionAssignment  
{
	...
	public ReflectionAssignment(String className) {
	...
	public static void main(String[] args) {
		String[] packageName= {"java.lang.String","java.io.InputStream","java.io.File"};
	for(int i=0;i<packageName.length;i++)
		{
			new ReflectionAssignment(packageName[i]);
		}
